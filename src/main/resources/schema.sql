drop table journal_comptable if exists;
drop table sequence_ecriture_comptable if exists;
drop table ecriture_comptable if exists;
drop table compte_comptable if exists;
drop table ligne_ecriture_comptable if exists;
